        ...
        <div class="row">
          <div class="col-lg-6 col-12">
            <div class="small-box bg-info">
              ...
              <a href="<?php echo base_url('admin/santri') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-12">
...
?>
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        <div class="card-body">
          <a href=<?php echo base_url("admin/santri_tambah") ?> class="btn btn-primary" style="margin-bottom:15px">
            Tambah Santri</a>
          <table id="datatable_01" class="table table-bordered">
            ...
            foreach ($santri as $d) { ?>
              <tr>
                ...
                <td>
                  <a href=<?php echo base_url("admin/santri_edit/") . $d['id_santri']; ?>> <i class="fas fa-pencil-alt"></i> </a>
                  <a href=<?php echo base_url("admin/santri_detil/") . $d['id_santri']; ?>>
                    <i class="fas fa-search-plus"></i></a>
                  <a href=<?php echo base_url("admin/santri_hapus/") . $d['id_santri']; ?> onclick="return confirm('Yakin menghapus Santri : <?php echo $d['nama_santri']; ?> ?');" ;><i class="fas fa-trash-alt"></i></a>
          ...
          <form method="POST" action="<?php echo base_url('admin/santri_tambah'); ?>" class="form-horizontal">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_santri" id="nama_santri" value="<?php echo set_value('nama_santri'); ?>" placeholder="Masukkan Nama Santri">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_alias" id="nama_alias" value="<?php echo set_value('nama_alias'); ?>" placeholder="Masukkan Nama Alias">
                  <span class="badge badge-warning"><?php echo strip_tags(form_error('nama_alias')); ?></span>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="badge badge-warning"><?php echo strip_tags(form_error('id_guru')); ?></span>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="badge badge-warning"><?php echo strip_tags(form_error('id_kelas')); ?></span>
                </div>
              </div>
    ...
    <section class="content">
      <div class="card">
        <div class="card-body">
          ...
          <form method="POST" action="<?php echo base_url('admin/santri_edit/' . $d['id_santri']); ?>" class="form-horizontal">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <label for="nama_santri" class="col-sm-2 col-form-label">Nama Santri</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_santri" id="nama_santri" value="<?php echo set_value('nama_santri', $d['nama_santri']); ?>" placeholder="Masukkan Nama Santri">
                  <span class="badge badge-warning"><?php echo strip_tags(form_error('nama_santri')); ?></span>
                </div>
              </div>
              ...
              <div class="form-group row">
                <label for="nama_alias" class="col-sm-2 col-form-label">Nama Alias</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_alias" id="nama_alias" value="<?php echo set_value('nama_alias', $d['nama_alias']); ?>" placeholder="Masukkan Nama Alias">
                  <span class="badge badge-warning"><?php echo strip_tags(form_error('nama_alias')); ?></span>
                </div>
              </div>
...
?>
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        <div class="card-body">
          <a href=<?php echo base_url("admin/guru_tambah") ?> class="btn btn-primary" style="margin-bottom:15px">Tambah guru</a>
            ...
            foreach ($guru as $d) { ?>
              <tr>
                ...
                <td>
                  ...
                  <a href=<?php echo base_url("admin/guru_hapus/") . $d['id_guru']; ?> onclick="return confirm('Yakin menghapus Guru : <?php echo $d['nama_guru']; ?> ?');" ;> Hapus</a>
          ...
          <form method="POST" action="<?php echo base_url('admin/guru_tambah'); ?>" class="form-horizontal">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_guru" id="nama_guru" value="<?php echo set_value('nama_guru'); ?>" placeholder="Masukkan Nama Guru">
                  <span class="badge badge-warning"><?php echo strip_tags(form_error('nama_guru')); ?></span>
                </div>
              </div>
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form method="POST" action="<?php echo base_url('admin/guru_edit/' . $d['id_guru']); ?>" class="form-horizontal">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <label for="nama_guru" class="col-sm-2 col-form-label">Nama Guru</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_guru" id="nama_guru" value="<?php echo set_value('nama_guru', $d['nama_guru']); ?>" placeholder="Masukkan Nama Guru">
                  <span class="badge badge-warning"><?php echo strip_tags(form_error('nama_guru')); ?></span>
                </div>
              </div>
