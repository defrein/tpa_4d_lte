          ...
          ?>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="feature-image">
                    <img src="<?php echo base_url(); ?>assets/landing/images/home-bg.jpg" class="img-responsive"
                        alt="Thin Laptop">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                <div class="team-thumb">
                    <img src="<?php echo base_url(); ?>assets/landing/images/guru01.jpg" class="img-responsive"
                        alt="Andrew Orange">
            ...
            <div class="col-md-4 col-sm-4">
                <div class="team-thumb">
                    ...
                    <img src="<?php echo base_url(); ?>assets/landing/images/guru02.jpg" class="img-responsive"
                        alt="Catherine Soft">
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="team-thumb">
                    <img src="<?php echo base_url(); ?>assets/landing/images/guru03.jpg" class="img-responsive"
                        alt="Jack Wilson">
                    <div class="team-info team-thumb-up">
                        <h2>Rahman</h2>
                        <small>Admin</small>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-offset-1 col-md-10 col-sm-12">
                ...
                <div class="col-md-6 col-sm-6">
                    <p>TPA - Aisyah bertempat di jalan... , yang merupakan bagian dari Langgar.. yang berada di
                        Banjarmasin.
                        TPA Aisya sudah berdiri sejak tahun 2010, dengan tenaga pengajar ngaji alumni dari ...
                        yang merupakan warga setempat yang sudah menyelesaikan santrinya dan mengamalkan ilmunya di
                        kampung halaman.
                    </p>
                    <p>
                        Kontak WA kami di nomor 0812 xxxx xxxx, atau langsung ke tempat TPA Aisya di jalan...
                        Banjarmasin.
                    </p>
                </div>
                <div class="col-md-6 col-sm-6">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1225.9788923161066!2d114.58219360734677!3d-3.296317730821318!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de4235ed24d6f7b%3A0xda02855136344eb0!2sUPT%20TIK%20Poliban%20(Gedung%20X)!5e0!3m2!1sen!2sid!4v1656401687338!5m2!1sen!2sid"
            ...
            <div class="copyright-text col-md-12 col-sm-12">
                ...
                <div class="col-md-6 col-sm-6">
                    <ul class="social-icon">
                        <li><a href="https://web.facebook.com/agus.sbn" class="fa fa-facebook-square"
